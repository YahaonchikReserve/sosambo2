          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Если вещ�� сбились в комок, барабан не может сбалансироваться. Встроенный датчик дисбаланса блокирует разгон, чтобы машина не «скакала» по комнате. Перетряхните бельё в барабане, добавьте несколько мелких вещей или, наоборот, разделите большую партию на две стирки. Так бельё ра��пределится равномерно, и отжим пройдёт без проблем.
                  </p>
            ...
            <PageNavigation
              ...
              nextPage={{
                ...
                title: 'Стиральная машина не открывается дверца'
              }}
            />
            <svg
              width="330"
