            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  ...
                  <span> Он удерживает мелкие предметы — монеты, пуговицы, ворсинки, — и со временем забивается. Когда фильтр перекрыт, вода не проходит в насос, и программа отжима не запускается. Обычно фильтр находится внизу на передней панели: от��ройте лючок, выкрутите пробку и удалите скопившийся мус��р. После очистки попробуйте снова включить стирку.</span>
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Если помпа сгорела или в ней сломана крыльчатка, машина не сможет слить воду и переход к отж��му невозможен. При��наки: вода остаётся в баке, машинка гудит во время слива или совсем молчит, и часто появляется ошибка слива на дисплее. Самостоятельный ремонт насоса обычно невозможен.
                </p>
              </div>
            </section>
