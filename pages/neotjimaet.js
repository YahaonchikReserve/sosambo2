          ...
          <div className="page-left-main-box">
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  ...
                  <span> Он удерживает мелкие предметы — монеты, пуговицы, ворсинки, — и со временем забивается. Когда фильтр перекрыт, вода не проходит в насос, и программа отжима не запускается. Обычно фильтр находится внизу на передней п��нели: от��ройте лючок, выкрутите пробку и удалите скопившийся мус��р. После очистки попробуйте снова включить стирку.</span>
                  ...
                  <span> Убедитесь, что вы не выбрали режим без отжима, на��ример «Полоскание без отжима» или «Деликатная стирка». В некоторых программах скорость вращения барабана снижена или отжим отключён полностью, чтобы не повредить ткан��. Если это так, просто перезапусти��е стирку с ��ужным режимом.</span>
                  <br className="page-text27"></br>
                  <span className="page-text28">4. Иногда проблема связана с загрузкой белья.</span>
                  <span> Если вещи сбились в комок, барабан не может сбалансироваться. Встроенный датчик дисбаланса блокирует разгон, чтобы машина не «скакала» по к��мнате. Перетряхните бельё в барабане, добавьте несколько мелких вещей или, наоборот, разделите большую партию на две стирки. Так бельё распределится равномерно, и отжим пройдёт без проблем.</span>
                  ...
                  <span> Вык��ючите стиральную машину из розетки на 10–15 минут, затем включите снова и запустите короткий цикл. Иногда этого ��остаточно, чтобы сбросить сбой программы.</span>
                  <br className="page-text27"></br>
            ...
            <section id="5-1" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Полный отказ мотора (обрыв обмоток или короткое замыкание) – серьёзная проблема. Признак – при отжиме машина «зависает», двигатель гудит или совсем тих, а барабан не крутитс����. Могут выбиваться пробки электрическ��й цепи. Ремонт двигателя – трудоёмкая операция, обычно его заменяют.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-better-call-master">
              ...
              <p className="page-text51">
                ...
                <span className="page-text54">РемCти��Маш</span>
