          ...
          <div className="page-left-main-box">
            ...
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Если после набора воды заметили под стира��кой воду в районе лотка для порошка, прич��ной часто бывает его засор. Тогда часть воды «уползает» мимо и вытекает наружу. Иногда лоток просто трескается ил�� расслаивается со временем – тогда вода тоже может уходить прямо через н��го.Совет: регулярно вынимайте и промывайте лоток для порошка и сам патруб��к подачи воды в бак. Если давление в водопроводе слишком сильное, воду может «выдавить» наружу – попробуйте немного прикрыть кран подачи. Не используйте слишком много моющего средства и только предназначенные для машин порошки – избыток пены тоже выгоняет влагу наружу. При появлении лужи на полу во время набора воды стоит отключить машинк��, собрать бельё и прочистить дозатор: обычно это быстро решает проблему.
                </p>
              </div>
            </section>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В некоторых случаях вода под машиной появляется только во время отжима – это характерно для износа подшипников и сальника барабана. Сальник (уплотнитель) насоса вращения постепенно истирается, из-за чего вода попадает внутрь подшипников и ��ыходит наружу. Сначала заметно лишь учащённое включение помпы аквастопа (если он есть), а потом ��� ржавая или с маслянистыми пятнами вода снизу. При этом маши��а громко гремит и «гуляет» на отжиме.Совет: осмотреть это своими силами можно только сняв заднюю панель, но замена подшипников – задача масте��а: приходится разбирать весь бак. Если вы слышите новые скрежет и вибрацию в сочета��ии с лужей под стиралкой, лучше как можно скорее вызвать специалиста. Регулярное использование специальных очистителей и держание машины в ровном положении может чуть замедлить износ, но окончательно устранить течь сможет только замена сальника и подшипников.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Внутри машины по-прежнему течёт вода – и эт�� легко заметить по лужице под ней при заливе. К аварийным патрубкам о��носятся труба от лотка дозатора к баку и любые трубочки между баком, насосом и фильтром. Со временем соединения этих патрубк��в ослабевают от пос��оянной вибрации, а сами трубки могут забиваться засохшей грязью и мелкими крошками п��рошка. Засорённая или неплотно подсоединённая труба начинает пропускать в��ду на стыках, которая капает в поддон или сразу на пол.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  <span className="tip-title">1. Проверяйте ка��маны и бережно укладывайте бельё.</span> Мелкие детали одежды – пуговицы, заклёпки, монеты – кладите в стиральные мешки.
                  <br />
                  ...
                  <br />
                  <span className="tip-title">3. Следите за шлангами и патрубками.</span> Убедитесь, что они хорошо закреплены и не имеют видимых повреждений. Меняйте шланги каждые нескольк�� лет или при первых признаках износа.
                  <br />
                  ...
                  <br />
                  <span className="tip-title">5. Обеспечьте ровную установку машины.</span> Стиральная машина должна стоят�� строго по уровню: е��ли она «гуляет», вибрации ускоряют износ деталей. Регулируйте ножки так, чтобы машина была неподвижна при работе.
                  <br />
