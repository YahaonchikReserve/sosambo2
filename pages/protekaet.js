            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Внутри машины по-прежнему течёт вода – и эт�� легко заметить по лужице под ней при заливе. К аварийным патрубкам о��носятся труба от лотка дозатора к баку и любые трубочки между баком, насосом и фильтром. Со временем соединения этих патрубк��в ослабевают от постоянной вибрации, а сами трубки могут забиваться засохшей грязью и мелкими крошками п��рошка. Засорённая или неплотно подсоединённая труба начинает пропускать в��ду на стыках, которая капает в поддон или сразу на пол.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  ...
                  <br />
                  <span className="tip-title">5. Обеспечьте ровную установку машины.</span> Стиральная машина должна стоят�� строго по уровню: если она «гуляет», вибрации ускоряют износ деталей. Регулируйте ножки так, чтобы машина была неподвижна при работе.
                  <br />
