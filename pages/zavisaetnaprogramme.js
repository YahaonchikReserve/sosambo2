        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                <p className="vicetext page-text18">
                  ...
                  <br />
                  Нажмите кнопку «Стоп» или «Пауза». В некоторых моделях ест�� отдельные режимы «Слив» или «Отжим» — ��ыберите их и запустите на минимальных оборотах. Часто такой сброс по��огает завершить цикл и вернуть управление.
                  <br />
                  ...
                  <br />
                  Если вода не уходит при штатных попытках, подставьте под фильтр глубокую ёмкость. Открутите сливной фильтр против часовой стрелки. После откручивания вода пойдёт в ёмкость; Слейте всю жидкость и уберите ��усор из фильтра и отверстия. Такие действия помогают во����становить слив во многих случаях.
                  <br />
                  <strong>4. После ручного слива можно безопасно открыть люк.</strong>
                  <br />
                  Обычно дверца автоматически разблокируется после снятия на��ряжения, но если она осталась заблокиров��нной, подождите несколько минут или разберите систему блокировки (иногда нужно подождать пока УБЛ «остынет»).
                  <br />
            ...
            <section id="2b" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  3. Проблемы с отводом воды (на��ос, патрубок, шланг)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="2d" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  5. Проблемы с датчиком уровня в��ды (прессостат)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="2e" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  ТЭН — это спираль, которая нагревает воду в баке. Если ТЭН не работа��т, вода не достигает нужной темпе��атуры, а блок управления бесконечно пытается её нагреть. Машина зависает: она набрала воду, но не греет её, пытаясь дотянуть до заданной температуры. Признаком неисправности ТЭНа являет��я холодное стекло люка при выбранной горячей программе и возможная ошибка нагрева на дисплее.
                </p>
              </div>
            </section>
              ...
              <div className="page-container33">
                ...
                <div className="page-container35">
                  ...
                  <span className="page-text62">
                    Стиральная машина не крутит бара��ан
                  </span>
                </div>
              </div>
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12981">
                <span className="page-text73">
                  Ошибки, которые приводят к дорогостоя��ему ремонту (и как их
                  избежать)
                </span>
