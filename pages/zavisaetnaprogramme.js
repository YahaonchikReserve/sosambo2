          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container13">
                <figure className="page-container14">
                  ...
                  <span className="page-text19">
                    <span>Зависшая стиральная машина</span>
                    <br></br>
                  </span>
                </figure>
                <p className="vicetext page-text18">
                  ...
                  <br />
                  Вытащите вилку из р��зетки или отключите питание автоматом в щитке. Так вы полностью снимете напряжение и исключите дальнейшие сбои.
                  <br />
            ...
            <section id="2b" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                <figure className="page-container18">
                  ...
                  />
                  <span className="page-text19">
                    <span>Проверка сливного шланга</span>
                    <br></br>
                  </span>
                </figure>
                <p className="vicetext">
            ...
            <section id="2d" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Прессостат — это датчик, который определяет, сколько воды набрано в бак. Если он выходит из строя, блок управления «не знает», наполнен ли барабан водой. В результате машина может остановиться сразу после начала набора ��оды или не доливать воду вовсе. Признаки: при такой неисправности машинка может резко остановиться на этапе набора, стирки, полоскания или отжима (�� зависимости от программы) и не продолжить цикл.
                </p>
              </div>
            </section>
